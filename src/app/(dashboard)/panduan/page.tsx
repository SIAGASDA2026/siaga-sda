...
const FAQS = [
  ...
  {
    q: 'Bagaimana cara mengakses SIAGA-SDA dari HP?',
    a: 'Buka browser di HP, ketik URL SIAGA-SDA, lalu login. Tampilan otomatis menyesuaikan layar HP. Semua fitur termasuk kamera dan GPS tersedia di browser HP.',
  },
  {
...
export default function PanduanPage() {
  ...
  return (
    <>
      <Topbar title="Tupoksi & Panduan" subtitle="Panduan penggunaan SIAGA-SDA" />
      <div className="p-5">
            ...
            {activeSection === 'mulai' && (
              <div className="bg-white rounded-xl border border-slate-100 p-6">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    <h2 className="text-base font-bold text-slate-800">Cara Mulai Menggunakan SIAGA-SDA</h2>
              ...
              <div className="bg-white rounded-xl border border-slate-100 p-6">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">FAQ penggunaan SIAGA-SDA</p>
                  </div>
                </div>
                <div className="space-y-2">
                  {FAQS.map((faq, i) => (
              ...
              <div className="bg-white rounded-xl border border-slate-100 p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-slate-50 rounded-xl text-center">
                    <div className="text-xs text-slate-500">SIAGA-SDA</div>
                    <div className="text-xs text-slate-400 mt-0.5">© 2026 Dinas Pekerjaan Umum Kota Dumai</div>
                    <div className="text-xs text-slate-400">Command Center SDA</div>
                  </div>
                </div>
              </div>
            )}
