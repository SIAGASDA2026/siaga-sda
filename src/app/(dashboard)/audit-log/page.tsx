...
const ACTION_META: Record<string, { label: string; color: string; icon: string }> = {
  ...
  APPROVAL_APPROVE: { label: 'Approval Disetujui', color: 'bg-emerald-100 text-emerald-700', icon: 'OK' },
  APPROVAL_REJECT:  { label: 'Approval Ditolak',   color: 'bg-red-100 text-red-700',        icon: 'NO' },
  APPROVAL_REQUEST_REVISION: { label: 'Approval Minta Revisi', color: 'bg-orange-100 text-orange-700', icon: 'REV' },
  APPROVAL_COMMENT: { label: 'Catatan Approval',   color: 'bg-blue-100 text-blue-700',      icon: 'MSG' },
