    ...
    >
      <section className="siaga-section-canvas p-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="siaga-card-info rounded-2xl p-4 text-sm text-cyan-900">
      ...
      <section className="siaga-panel-canvas p-5">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-6">
          {SURAT_WORKFLOW_STEPS.map((step, index) => (
            <div key={step.id} className="siaga-card-info rounded-2xl p-3">
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <div className="siaga-card-neutral rounded-2xl p-5">
        ...
        <div className="siaga-card-recommendation rounded-2xl p-5">
      ...
      <section className="siaga-panel-canvas p-5">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
          {SURAT_FOLLOW_UP_ACTIONS.map((action) => (
            <Link key={action.id} href={action.href} className="siaga-card-interactive siaga-card-neutral group p-4">
      ...
      <section className="siaga-panel-canvas p-5">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {[
            ...
            <Link key={item.href} href={item.href} className="siaga-card-interactive siaga-card-neutral inline-flex items-center gap-2 px-3 py-2 text-xs font-extrabold text-slate-700">
              {item.label}
      ...
      <section className="siaga-panel-canvas siaga-card-warning p-5">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2">
          {SURAT_CONCEPT_DEMO_ITEMS.map((item) => (
            <div key={item.id} className="siaga-card-compact rounded-2xl p-4">
      ...
      <section className="siaga-card-success rounded-2xl p-4 text-sm text-emerald-900">
