  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="text-center max-w-sm">
        <div className="w-20 h-20 bg-[#0D2C54] rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-blue-200">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link
            href="/dashboard"
            className="flex items-center gap-2 px-4 py-2.5 bg-[#1976D2] text-white rounded-xl text-sm font-semibold hover:bg-[#0D2C54] transition-colors"
          >
            <Home className="w-4 h-4" /> Dashboard
          </Link>
        </div>
        <div className="mt-10 text-xs text-slate-300">{BRAND.name} - {BRAND.unit} {BRAND.city}</div>
      </div>
    </div>
  )
}
