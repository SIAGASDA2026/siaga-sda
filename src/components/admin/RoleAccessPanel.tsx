      ...
      <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-xl border border-slate-100 bg-white p-4">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {visibleRoles.map((role) => {
              ...
              return (
                <div key={role.val} className="rounded-xl border border-slate-100 p-4">
                  ...
                  <div className={`mt-3 rounded-lg px-3 py-2 text-xs font-semibold ${currentCanManage ? 'bg-green-50 text-green-700' : 'bg-slate-50 text-slate-500'}`}>
        ...
        <div className="rounded-xl border border-slate-100 bg-white p-4">
          ...
          <div className="space-y-2">
            {users.length === 0 ? (
              <div className="rounded-xl bg-slate-50 p-4 text-sm text-slate-500">Belum ada user.</div>
            ) : users.map((user) => {
