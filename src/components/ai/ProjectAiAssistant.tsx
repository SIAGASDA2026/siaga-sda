    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-[70] bg-slate-950/45 p-3 md:flex md:items-end md:justify-end" onClick={() => setOpen(false)}>
          <div className="ml-auto flex h-[calc(100dvh-1.5rem)] w-full flex-col overflow-hidden rounded-2xl bg-white shadow-2xl md:h-[720px] md:max-h-[90vh] md:w-[500px]" onClick={(event) => event.stopPropagation()}>
            <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-bold text-slate-900">AI Analisis {BRAND.name}</div>
