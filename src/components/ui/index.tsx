...
export function EmptyState({ icon, title, description, action }: {
  ...
  return (
    <div className="siaga-empty-canvas flex flex-col items-center justify-center px-4 py-14 text-center">
      <div className="siaga-card-neutral mb-4 flex h-16 w-16 items-center justify-center rounded-2xl text-slate-500">
        {icon}
      </div>
