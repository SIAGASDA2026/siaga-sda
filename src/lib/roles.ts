...
export const ROLE_DEFINITIONS: RoleDefinition[] = [
  ...
  },
  {
    val: 'tim_survey',
    label: 'Tim Survey',
    desc: 'Petugas survey lapangan untuk pendataan awal dan pekerjaan rutin.',
    tugas: ['Mengambil data lapangan', 'Menginput foto dan GPS survey', 'Mencatat kondisi eksisting'],
    hak: ['Input survey', 'Lihat proyek yang ditugaskan', 'Lihat dokumen survey'],
    color: 'teal',
  },
  {
    val: 'tim_pengawasan',
  ...
  },
  {
    val: 'auditor',
    label: 'Auditor',
    desc: 'Pemeriksa independen dengan akses baca dan audit trail.',
    tugas: ['Memeriksa rekam jejak kegiatan', 'Mereview kelengkapan dokumen', 'Menilai kepatuhan workflow'],
    hak: ['Lihat dashboard', 'Lihat laporan dan dokumen', 'Lihat audit log', 'Tidak dapat mengubah data'],
    color: 'slate',
  },
]
