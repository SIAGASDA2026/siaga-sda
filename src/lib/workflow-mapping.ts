...
export const WORKFLOW_ROLE_ACTIONS: ReadonlyArray<{
  ...
  { role: 'admin_peil_banjir', frontendRole: 'admin_peil_banjir', allowedConcept: 'Runtime frontend disiapkan terbatas untuk Dashboard, Surat, dan Peil Banjir. Prisma enum/database belum dimigrasikan.' },
  { role: 'tim_teknis_peil_banjir', frontendRole: 'tim_teknis_peil_banjir', allowedConcept: 'Runtime frontend disiapkan terbatas untuk Dashboard dan Peil Banjir. Prisma enum/database belum dimigrasikan.' },
