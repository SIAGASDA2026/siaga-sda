...
Halaman ini menjadi ruang kerja khusus role `SUPER_ADMIN` sesuai assignment aktif, bukan akses global sembarangan.
...
- Menghapus histori permanen tanpa migration/audit
