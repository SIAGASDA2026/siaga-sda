# SIAGA-SDA Konsultan Perencana UI
...
Halaman ini menjadi ruang kerja khusus role `KONSULTAN_PERENCANA` sesuai assignment aktif, bukan akses global sembarangan.

## Hak Akses Utama

- Upload gambar teknis
- RAB/BOQ/HPS/AHSP
- KAK/TOR
- Backup data
...
- Melihat paket lain yang tidak ditugaskan
