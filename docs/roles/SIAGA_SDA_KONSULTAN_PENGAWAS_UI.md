...
# SIAGA-SDA Konsultan Pengawas UI
...
Halaman ini menjadi ruang kerja khusus role `KONSULTAN_PENGAWAS` sesuai assignment aktif, bukan akses global sembarangan.

## Hak Akses Utama

- Review laporan kontraktor
- Upload laporan pengawasan
- Monitoring deviasi
- Rekomendasi teknis
- Pemeriksaan progres
