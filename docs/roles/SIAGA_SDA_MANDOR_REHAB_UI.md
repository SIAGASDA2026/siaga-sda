...
# SIAGA-SDA Mandor Rehab Drainase UI
...
Halaman ini menjadi ruang kerja khusus role `MANDOR_REHAB_DRAINASE` sesuai assignment aktif, bukan akses global sembarangan.

## Hak Akses Utama

- Mengatur tim rehab drainase
- Input pekerjaan harian rehab
