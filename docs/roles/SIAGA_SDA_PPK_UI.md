...
Halaman ini menjadi ruang kerja khusus role `PPK` sesuai assignment aktif, bukan akses global sembarangan.

## Hak Akses Utama

- Approval final paket
- Approval formal survey menjadi pekerjaan/administrasi
- Monitoring kontrak
- SPM/pembayaran
- PHO/FHO final
