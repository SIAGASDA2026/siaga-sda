...
Halaman ini menjadi ruang kerja khusus role `KONTRAKTOR` sesuai assignment aktif, bukan akses global sembarangan.

## Hak Akses Utama

- Input laporan harian/mingguan/bulanan
- Upload dokumentasi
- Ajukan MC/Opname
- Ajukan PHO/FHO
