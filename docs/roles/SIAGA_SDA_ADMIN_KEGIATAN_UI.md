...
Halaman ini menjadi ruang kerja khusus role `ADMIN_KEGIATAN` sesuai assignment aktif, bukan akses global sembarangan.

## Hak Akses Utama

- Mengelola administrasi kegiatan yang ditugaskan
- Input kontrak
- SPK/SPMK
- Addendum
- SPM/pembayaran
...
- Mengelola kegiatan di luar assignment
